function main() {
  ...
  const thicknessUniformLocation = gl.getUniformLocation(program, `thickness`);
  ...
  function mouseClick(e) {
    ...
    switch (mode) {
      case 0:
        ...
        break;
      case 1:
        if (tempVector.length == 6) {
          gl.clear(gl.COLOR_BUFFER_BIT);
          bresenham(tempVector[0], tempVector[2], tempVector[1], tempVector[3]);
          bresenham(tempVector[2], tempVector[4], tempVector[3], tempVector[5]);
          bresenham(tempVector[4], tempVector[0], tempVector[5], tempVector[1]);
          positionVector = colorVec;
          tempVector = [];
        }
        if (colorVec.length >= 6)
          colorVec = [];
        break;
    }
    ...
    switch (funcao) {
      case 0: // cor
        switch (e.key) {
          ...
          case 'R':
            mode = 0;
            console.log('Modo de desenho em linhas');
            break;
          case 't':
          case 'T':
            mode = 1;
            console.log('Modo de desenho em triângulo');
            break;

          case 'e':
          case 'E':
            funcao = 1;
            console.log('Modo de espessura');
            break;

          case 'k':
          case 'K':
            funcao = 0;
            console.log('Modo de cor');
            break;
        }
        draw2DPoints();
        colorVec = [];
      ...
      case 1: // espessura
        switch (e.key) {
          case '0':
            gl.uniform1f(thicknessUniformLocation, 1.0);
            break;
          case '1':
            gl.uniform1f(thicknessUniformLocation, 3.0);
            break;
          case '2':
            gl.uniform1f(thicknessUniformLocation, 5.0);
            break;
          case '3':
            gl.uniform1f(thicknessUniformLocation, 7.0);
            break;
          case '4':
            gl.uniform1f(thicknessUniformLocation, 9.0);
            break;
          case '5':
            gl.uniform1f(thicknessUniformLocation, 11.0);
            break;
          case '6':
            gl.uniform1f(thicknessUniformLocation, 13.0);
            break;
          case '7':
            gl.uniform1f(thicknessUniformLocation, 15.0);
            break;
          case '8':
            gl.uniform1f(thicknessUniformLocation, 17.0);
            break;
          case '9':
            gl.uniform1f(thicknessUniformLocation, 19.0);
            break;
