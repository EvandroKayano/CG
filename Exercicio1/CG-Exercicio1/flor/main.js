...
TUDO CERTO POR AQUI SÓ TO ESCREVENDO PRO CTRL+Z NÃO PASSAR
    ...
    // CAULE
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setRectangleVertices(gl,-0.1,-1,0.2,1);
    gl.bindBuffer(gl.ARRAY_BUFFER,colorBuffer)
    ...
    // FOLHA
    gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
    setPetals(gl,30,0.2,[-0.1,-0.7],[0.3,-0.7]);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    ...
    // R
    gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
    setPetals(gl,n,0.2,[0,0.25],[-0.45,0.4]);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl,n,petalColor);
    gl.drawArrays(gl.TRIANGLES, 0, 3*n);

    gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
    setPetals(gl,n,0.2,[0,0.25],[-0.45,0.06]);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl,n,petalColor);
    gl.drawArrays(gl.TRIANGLES, 0, 3*n);
    // L
    ...
    // S
    gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
    setPetals(gl,n,0.2,[0,0.25],[-0.16,-0.2]);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl,n,petalColor);
    gl.drawArrays(gl.TRIANGLES, 0, 3*n);
    ...
    // N
    gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
    setPetals(gl,n,0.2,[0,0.25],[-0.16,0.65]);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl,n,petalColor);
    gl.drawArrays(gl.TRIANGLES, 0, 3*n);
    ...
    n=30;
    gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
    setCircleVertices(gl,n,0.2,[0,0.25]);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
